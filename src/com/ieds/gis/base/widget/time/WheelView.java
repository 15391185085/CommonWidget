...
class WheelView extends View {
	...
	private static final int ADDITIONAL_ITEM_HEIGHT = (int)BaseApp.getmContext().getResources().getDimension(R.dimen.time_item_height);

	/** Text size */
	private int TEXT_SIZE = (int)BaseApp.getmContext().getResources().getDimension(R.dimen.time_text);
